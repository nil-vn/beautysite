 ...
 *
 */
class wpCSL_notifications__ {

    /**
     * @var wpCSL_notifications_notice__[] $notices and array of notice boxes.
     */
    ...
    function add_notice($level = 1, $content='', $link = null) {
        ...
        $this->notices[] = new wpCSL_notifications_notice__(
            array(
                'level' => $level,
                'content' => $content,
                'link' => $link
 ...
 *
 */
class wpCSL_notifications_notice__ {
